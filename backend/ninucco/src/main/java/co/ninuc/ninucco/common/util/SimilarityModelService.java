...
@Component
@Slf4j
public class SimilarityModelService extends InterServiceCommunicationProvider{
    private JSONObject getJsonObject(String modelType, byte[] imgByteArray){
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .build();
        Optional<JSONObject> res = postRequestSendRequestbodyGetJsonObject("http://localhost:8000/predict",
                Headers.of(
